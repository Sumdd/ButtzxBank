...
namespace XC.RSAUtil
{
    ...
    public class RsaKeyConvert
    {
        ...
        public static string PublicKeyPemToXml(string publicKey)
        {
            ...
            rsaKey = obj as RsaKeyParameters;
        ...
        public static string Public16ToPem(string modulus)
        {
            //Exponent
            var exponent = "AQAB";

            RsaKeyParameters rsaKeyParameters = new RsaKeyParameters(false, new BigInteger(1, Convert.FromBase64String(modulus)), new BigInteger(1, Convert.FromBase64String(exponent)));
        ...
        public static string PrivateKeyPkcs1ToXml(string privateKey)
        {
            ...
            if (!(pr.ReadObject() is AsymmetricCipherKeyPair))
            {
                throw new Exception("Private key format is incorrect");
            }
            asymmetricCipherKeyPair = pr.ReadObject() as AsymmetricCipherKeyPair;
